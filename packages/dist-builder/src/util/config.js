...
export const getConfig = async () => {
  ...
  const { modern, ssr, legacy, widget, testWidget, clean = true, monoRepoName } = config
  ...
  return { modern, ssr, legacy, clean, cjs, umd, hasEsmBuilds, hasLegacyBuilds, hasEsmAndLegacyBuilds, widget, testWidget, monoRepoName }
}