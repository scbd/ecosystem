<template>
  <ul class="navbar-nav mr-auto">
    <li @mouseover="open(index)" @mouseleave="close(index)" v-on:click.capture="toggle(index)" v-for="(aMenu,index) in menuItems" :key="index" :id="makeSelector(aMenu, 'SNE')" class="topmenu nav-item dropdown">
